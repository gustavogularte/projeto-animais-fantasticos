...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initTabNav)\n/* harmony export */ });\nfunction initTabNav() {\n  var imagemPrincipal = document.querySelector('.animais-imagens-principal img');\n  var imagensThumb = document.querySelectorAll('.animais-imagens-thumb img');\n  var animaisDescricao = document.querySelectorAll('.animais-descricao section');\n  function mostrarImagem(img, index) {\n    // trocar imagem\n    var src = img.getAttribute('src');\n    var classNomePrincipal = imagemPrincipal.attributes[0].nodeValue;\n    var novaClass = img.attributes[0].nodeValue;\n    imagemPrincipal.setAttribute('src', src);\n    imagemPrincipal.classList.replace(classNomePrincipal, novaClass);\n\n    // trocar descrição\n    animaisDescricao.forEach(function (item) {\n      item.classList.remove('ativo');\n    });\n    var direcao = animaisDescricao[index].dataset.anime;\n    animaisDescricao[index].classList.add('ativo', direcao);\n  }\n  if (imagemPrincipal && imagensThumb.length && animaisDescricao.length) {\n    imagensThumb.forEach(function (img, index) {\n      img.addEventListener('click', function () {\n        mostrarImagem(img, index);\n      });\n    });\n  }\n}\n\n//# sourceURL=webpack://projeto-animais-fantasticos/./js/modules/tabnav.js?");
